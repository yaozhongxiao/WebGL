...
glProgram.prototype.setVertexArray = function(webgl_context, VertexArray, VertexSize){
    ...
    webgl_context.vertexAttribPointer(gl_Position_ID,3,webgl_context.FLOAT,true,0,0);
}

glProgram.prototype.setColor = function(webgl_context, jsColor){
    var v_color = vec3.create(jsColor);
    var v_color_id = webgl_context.getActiveAttrib(this._program, glShader.VertexParameter.gl_Color);
